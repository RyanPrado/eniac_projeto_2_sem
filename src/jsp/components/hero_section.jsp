...
<section class="hero-section py-16 flex flex-col lg:flex-row gap-2 items-center">
    <div class="w-full lg:w-2/3 xl:w-1/2">
        <h1 class="text-4xl sm:text-6xl font-semibold text-left text-balance">
            Procurando um serviço de qualidade?
        </h1>
        <br/>
